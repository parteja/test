...
//   02. Map Shortcodes
//   03. Update Existing Shortcodes
//   04. Remove Default Shortcodes
//   05. Remove Teaser Metabox
...
if ( class_exists( 'WPBakeryVisualComposer' ) ) :
  if ( ! function_exists( 'x_visual_composer_map_shortcodes' ) ) :
    ...
    function x_visual_composer_map_shortcodes() {
      ...
      $category_content          = __( 'Content', '__x__' );
      $category_information      = __( 'Information', '__x__' );
      $category_marketing        = __( 'Marketing', '__x__' );
      $category_media            = __( 'Media', '__x__' );
      $category_social           = __( 'Social', '__x__' );
      $category_structure        = __( 'Structure', '__x__' );
      $category_typography       = __( 'Typography', '__x__' );

      $param_content_name        = 'content';
      $param_content_heading     = __( 'Text', '__x__' );
      $param_content_description = __( 'Enter your text.', '__x__' );
      $param_content_type        = 'textarea_html';
      $param_content_holder      = 'div';
      $param_content_value       = '';

      $param_id_name             = 'id';
      $param_id_heading          = __( 'ID', '__x__' );
      $param_id_description      = __( '(Optional) Enter a unique ID.', '__x__' );
      $param_id_type             = 'textfield';
      $param_id_holder           = 'div';

      $param_class_name          = 'class';
      $param_class_heading       = __( 'Class', '__x__' );
      $param_class_description   = __( '(Optional) Enter a unique class name.', '__x__' );
      $param_class_type          = 'textfield';
      $param_class_holder        = 'div';

      $param_style_name          = 'style';
      $param_style_heading       = __( 'Style', '__x__' );
      $param_style_description   = __( '(Optional) Enter inline CSS.', '__x__' );
      $param_style_type          = 'textfield';
      $param_style_holder        = 'div';
      ...
      vc_map(
        array(
          ...
          'params'      => array(
            ...
            array(
              'param_name'  => $param_style_name,
              'heading'     => $param_style_heading,
              'description' => $param_style_description,
              'type'        => $param_style_type,
              'holder'      => $param_style_holder
            )
          )
        )
      );
