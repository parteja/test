...
// =============================================================================
// FUNCTIONS/GLOBAL/ADMIN/TMG-PLUGIN-REGISTRATION.PHP
// -----------------------------------------------------------------------------
// Registers the plugins to be included via the TMG Plugin Registration class.
// =============================================================================

// =============================================================================
// TABLE OF CONTENTS
// -----------------------------------------------------------------------------
//   01. Automated Plugin Installation
// =============================================================================
  ...
  function x_register_theme_plugins() {
    ...
    $plugins = array(
      array(
        'name'               => 'X Shortcodes',
        'slug'               => 'x-shortcodes',
        'source'             => get_template_directory_uri() . '/framework/plugins/x-shortcodes.zip',
        'required'           => true,
        'version'            => '',
