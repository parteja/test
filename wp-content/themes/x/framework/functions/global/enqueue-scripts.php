...
if ( ! function_exists( 'x_enqueue_customizer_preview_scripts' ) ) :
  function x_enqueue_customizer_preview_scripts() {
    ...
    wp_register_script( 'customizer-preview-js', get_template_directory_uri() . '/framework/js/admin/customizer-preview.min.js', array( 'jquery', 'customize-preview' ), NULL, true );
